...
const Login = () => {
  ...
  return (
    <div className='mb-5 bg-[#2B3674] h-screen flex flex-col '> {/*  bg-[#FAFAFA]  */}
            ...
            <div className="h-[300px] mt-5">
                ...
                <Form onSubmit={handleSubmit} className="flex flex-col lg:items-center">
                    <div className='flex flex-col gap-6 lg:items-center h-[47px]'>
                        ...
                        <button 
                            className= " bg-[#2B3674] mt-5  xs:w-full lg:w-[420px] text-[#fff] rounded-lg p-3 cursor-pointer w-full h-[54px] flex justify-center"
                            type="submit"
                        >
