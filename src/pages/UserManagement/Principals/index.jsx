...
const Principals = () => {
  ...
  const getAllPrincipals = async () => {
    setLoading(true)
      await api.get(appUrls?.GET_ALL_PRINCIPALS)
      .then((res) => {
        console.log(res, "sap")
        setLoading(false)
        setAllPrincipals(res?.data?.data?.user)
      })
      .catch((err) => {
        setLoading(false)
  ...
  return (
    <div className='py-5 px-14 flex flex-col bg-[#F4F7FE]'>
      ...
      <div className='flex justify-between mt-[28px]'>
        <p className='font-barlow text-[#2B3674] text-[24px] font-semibold'>Principals</p>
        ...
        <div className='flex gap-4 items-center'>
          ...
          <button
            onClick={() => navigate("/add-principal")}
          ...
          >
            ...
            <p className='text-[#fff] font-barlow font-medium'>Add New Principal</p>
          </button>
        </div>
      </div>
      ...
      <div className='flex gap-3 mt-5 items-center'>
        ...
        <div className='bg-[#fff] w-[267px] h-[104px] gap-2.5 rounded-xl p-4 flex items-center'>
          ...
          <div className='flex flex-col gap-1.5'>
            ...
            <p className='text-[#2B3674] font-medium font-barlow text-[19px]'>{allPrincipals?.length}</p>
          </div>
        </div>
        ...
        <div className='bg-[#fff] w-[267px] h-[104px] gap-2.5 rounded-xl p-4 flex items-center'>
          ...
          <div className='flex flex-col gap-1.5'>
            <p className='text-[#A3AED0] font-inter'>Verified Principals</p>
            <p className='text-[#2B3674] font-medium font-barlow text-[19px]'>{allPrincipals?.length}</p>
          </div>
        </div>
