...
const Admin = () => {
  ...
  const getAllAdmins = async () => {
    setLoading(true)
      await api.get(appUrls?.GET_ALL_ADMINS)
      .then((res) => {
        console.log(res, "asap")
        setLoading(false)
        setAllAdmins(res?.data?.data?.users)
      })
      .catch((err) => {
        setLoading(false)
    ...
    <div className='py-5 px-14 flex flex-col bg-[#F4F7FE]'>
      <div className='flex items-center'>
        ...
        <div className='w-[92px] h-[28px] bg-[#F4ECEE] rounded-[6px] p-2'>
          <p className='text-[#F55425] font-inter font-medium text-xs text-center'>Admin List</p>
        </div>
      </div>
      <div className='flex justify-between mt-[28px]'>
        ...
        <div className='flex gap-4 items-center'>
          ...
          >
            ...
            <p className='text-[#fff] font-barlow font-medium'>Add New Admin</p>
          </button>
        </div>
      </div>
      ...
      <div className='flex gap-3 mt-5 items-center'>
        ...
        <div className='bg-[#fff] w-[545px] h-[104px] gap-2.5 rounded-xl p-4 flex items-center'>
          ...
          <div className='flex flex-col gap-1.5'>
            <p className='text-[#A3AED0] font-inter'>Total Admin</p>
        ...
        <div className='bg-[#fff] w-[545px] h-[104px] gap-2.5 rounded-xl p-4 flex items-center'>
          ...
          <div className='flex flex-col gap-1.5'>
            <p className='text-[#A3AED0] font-inter'>Active Admin</p>
            <p className='text-[#2B3674] font-medium font-barlow text-[19px]'>{allAdmins?.length}</p>
          </div>
        </div>
