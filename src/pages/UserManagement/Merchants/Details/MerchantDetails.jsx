  ...
  return (
    <div className='py-5 px-14 flex flex-col'>
        <div className='flex items-center gap-2'>
            ...
            <p className='text-[#D0D5DD] font-inter cursor-pointer font-medium text-xs text-center' onClick={() => navigate("/merchants")}>Merchants List</p>
            <MdOutlineKeyboardArrowRight className='w-4 h-4 text-[#D0D5DD]' />
            <div className='w-[120px] h-[28px] bg-[#F4ECEE] rounded-[6px] p-2'>
                <p className='text-[#F55425] font-inter font-medium text-xs text-center'>Merchants Details</p>
            </div>
        </div>
        <div className='flex items-center justify-between mt-5'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <button onClick={() => enableDisableUser()} className={`${state?.active === "1" ? "bg-[#FF0000]" : "bg-[#0F973D]"} w-[168px] h-[48px] rounded-lg  flex items-center justify-center p-2`}>
                  {
                    loading ?
                    ...
                    <div className='flex items-center gap-1.5 justify-between'>
                      ...
                      <p className='text-[#FFF] font-barlow font-medium'>{state?.active === "1" ? "Disable Merchant" : "Verify Merchant" }</p>
                    </div>
                  }
                </button>
            </div>
